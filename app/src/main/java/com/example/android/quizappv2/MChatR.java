...
public class MChatR extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_m_chat_r);
    ...
    public void exampleButton(View view) {
        Intent intent = new Intent(MChatR.this, ExampleWindow.class);
    ...
    public void updateQuestion() {
        String questionArray[] = getResources().getStringArray(R.array.MchatQuestions);
    ...
    public void displayWarningToast() {
        ...
        View view = myInflater.inflate(R.layout.toast_warning_message, (ViewGroup) findViewById(R.id.toast_root));
    ...
    public void toScoreScreen() {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
                    public void run(){
                Intent i = new Intent(MChatR.this, ScoreScreen.class);
